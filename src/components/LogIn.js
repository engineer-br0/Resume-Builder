  ...
  return (
    <>
      ...
      <div className={isDarkMode ? styles.containerDark : styles.container}>
        <div className={isDarkMode ? styles.headerDark : styles.header}>
          Log In
        </div>
        <p style={{ fontFamily: "sans-serif", fontWeight: "lighter" }}>
          Welcome Back!
        </p>
        <div className={styles.container}>
          <div className={styles.content}>
            ...
            <p style={{ color: "violet" }}>
              Use testing account: test1@gmail.com Password: test@123
            </p>
            <p>
            ...
            >
              ...
              <br></br>
              <div
                onClick={handleSubmissionGoogle}
